...
<html>
    <head>
        ...
        <script type="text/javascript" scr="<c:url value="/static/js/jquery-1.11.1.js"/>"></script>
                <script type="text/javascript" scr="<c:url value="/static/js/jquery-validate/jquery.validate.min.js"/>"></script>
                        <script type="text/javascript" scr="<c:url value="/static/js/jquery-validate/additional-methods.min.js"/>"></script>
